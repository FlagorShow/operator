...
$packages = $conn->query("SELECT * FROM packages WHERE type = 'sms'");
...
<body>
    <div class="container">
        <h1 class="tariff-title">SMS-пакеты</h1>
            ...
            <div class="carousel-inner">
                <?php while($package = $packages->fetch_assoc()): ?>
                    <div class="tariff-block">
                        <h2><?= htmlspecialchars($package['amount']) ?> SMS</h2>
