...
$packages = $conn->query("SELECT * FROM packages WHERE type = 'data'");
...
<body>
    <div class="container">
        <h1 class="tariff-title">Пакеты интернета</h1>
            ...
            <div class="carousel-inner">
                <?php while($package = $packages->fetch_assoc()): ?>
                    <div class="tariff-block">
                        <h2><?= htmlspecialchars($package['amount']) ?> ГБ</h2>
